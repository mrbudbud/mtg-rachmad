  ...
  <body>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light my-3">
            <a class="navbar-brand" href="#"><h1>Master Item</h1></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a  href="{{url('/')}}">List Transaksi <span class="sr-only">(current)</span></a>
                </li>
        ...
        <tbody>
            @foreach ($dataMaster as $item)
                <tr>
                    ...
                    <td>
                        <center>
                        <a href="{{url('/edit/master', $item->id)}}" class="btn btn-warning">Edit</a>
                        <!-- Button trigger modal -->
